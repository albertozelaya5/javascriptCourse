...
const displayMovements = function (acc, sort = false) {
  ...
  // console.log('🚀 ~ displayMovements ~ combinedMovsDates:', combinedMovsDates);

  // const movs = sort
  //   ? combinedMovsDates.slice().sort((a, b) => a.movement - b.movement) //*Sort afecta el array original
  //   : combinedMovsDates;
  ...
  combinedMovsDates.forEach(function (obj, i) {
    ...
    const date = new Date(movementDate); //*Por cada movimiento
...
const startLogOutTimer = function () {
  let time = 94000; //* Conversion segundos a minutos
  const tick = () => {
